...
func == (lhs: NSLayoutXAxisAnchor, rhs: Expression<NSLayoutXAxisAnchor>) -> NSLayoutConstraint {
    ...
    return rhs.activity.setting(constraint: constraint)
}
...
@discardableResult
func == <C>(lhs: NSLayoutDimension, rhs: C) -> NSLayoutConstraint where C:BinaryFloatingPoint {
...
func | (lhs: NSLayoutConstraint, rhs: Activity) -> NSLayoutConstraint {
    return rhs.setting(constraint: lhs)
}
...
func | (lhs: NSLayoutConstraint, rhs: (Activity, String?)) -> NSLayoutConstraint {
    ...
    return rhs.0.setting(constraint: lhs)
}
