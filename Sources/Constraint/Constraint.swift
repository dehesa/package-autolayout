...
extension LayoutConstraintGroup {
    public var constant: Self.Constant {
        get { return .init(self.map { $0.constant })}
        set { zip(self, newValue).forEach { $0.constant = $1 } }
    }
}

extension LayoutConstraintGroup where
            Self.Constant.Iterator == LayoutIteratorPair<CGFloat>,
...
extension LayoutConstraintGroup where
            Self.Identifier == (String?, String?, String?, String?),
